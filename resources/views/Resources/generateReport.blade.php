...
@section('content')
    ...
    @if($resourcesSet != false)
        ...
        <div class="container">
            <div class="container">
                <a class="btn btn-small btn-danger pull-left" href="{{ URL::to('resources/emptyReport') }}" style="margin-bottom: 20px;">Empty Report</a>
                <a class="btn btn-small btn-info pull-right" target="_blank" href="{{ URL::to('resources/generatePDF') }}" style="margin-bottom: 20px;">External Preview</a>
            </div>
            <div>
