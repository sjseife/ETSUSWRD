...
<img id="header" src="C:\Users\stan2\Documents\Soft Eng II\MasterPresentation\public\images\sw_logo.jpg">
@if(!$events->isEmpty())
...
@if(!$resources->isEmpty())
    @if(!$events->isEmpty())
        <h2 class="resource-header" style="text-align: center">Resources</h2>
    @else
