    ...
    <div class="content">
        ...
        <form class="form-horizontal" method="POST" action="/contact/{{$id->id}}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="FirstName" name="FirstName" type="firstName" value="{{$id->firstName}}" class="form-control input-md">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label" for="user_id">Last Name</label>
                <div class="col-md-4">
                    <input id="LastName" name="LastName" type="lastName" value="{{$id->lastName}}" class="form-control input-md">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label" for="user_id">Phone Number</label>
                <div class="col-md-4">
                    <input id="PhoneNumber" name="PhoneNumber" type="phoneNumber" value="{{$id->phoneNumber}}" class="form-control input-md">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label" for="user_id">Email</label>
                <div class="col-md-4">
                    <input id="Email" name="Email" type="eamil" value="{{$id->email}}" class="form-control input-md">
                </div>
            </div>
