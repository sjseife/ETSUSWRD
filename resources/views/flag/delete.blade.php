    ...
    <div class="content">
        <form class="form-horizontal" method="post" action="/flag/destroy/{{$id->Id}}" accept-charset="UTF-8">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <select id="Level" name="Level" class="form-control input-md" disabled>
                        @if($id->Level == 0)
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="Date" name="Date" type="date" value="{{$id->Date}}" class="form-control input-md" disabled>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label" for="user_id">Submitted By</label>
                <div class="col-md-4">
                    <select id="submitted_by" name="submitted_by" class="form-control input-md" disabled>
                        @foreach($user as $u)
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <textarea name="Comments" id="Comments" cols="30" rows="4" class="form-control input-md" disabled>{{$id->Comments}}</textarea>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <button id="submit_button" type="submit" class="btn btn-danger">Delete</button>
                </div>
            </div>
        </form>
    </div>
